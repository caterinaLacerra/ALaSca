...
In the [supplementary material](https://github.com/caterinaLacerra/alasca/blob/main/docs/assets/supplementary_alasca.pdf) we provide the results for each tuned value for the similarity threshold.
