...
---
This website contains a new dataset large-scale dataset for the task of lexical substitution. The automated procedure to obtain the dataset is described in the [ALaSca]() paper. 
## Abstract
